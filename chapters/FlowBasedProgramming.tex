...
\par Nodes can specialize themselves in a flow-based program by assuming specific roles. The roles allow nodes to form a more consistent architecture. This also makes a node arrangement adhere more closely to the lifetime rule of nodes.

\section{Flows}

\paragraph{  } The final topic to introduce in flow-based programming are flows themselves.
